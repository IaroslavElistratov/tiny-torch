...
int test_maxpool() {
    ...
    // tensor* upstream = TensorLikeFill3d(out, 1.0);
    ...
    // tensor* upstream = TensorLikeFill4d(out, 1.0);
...
int test_bmm() {
    ...
    tensor* input = Tensor3d(B, N, M);
    set_name(input, "input"); print_3d(input);

    tensor* weight = Tensor3d(B, M, D);
